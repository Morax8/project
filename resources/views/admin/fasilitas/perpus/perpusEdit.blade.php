@extends(' layout.app')
@section('title', 'Perpus Edit')

@section('content')

<div class="container">
    <div class="row">
        <a href="/perpuscms" class="btn btn-primary">Kembali</a>
        <div class="col-md-12">
            <form action="{{ route('fasilitas.update', ['type' => 'perpus', 'id' => $perpus->id]) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <input type="hidden" class="form-control" name="id" value="{{ $perpus->id }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="file-picker" class="form-control" rows="30" name="content"
                        placeholder="Content">{{ $perpus->content }}</textarea>
                </div>
                <div class="form-group">
