...
<div class="container">
    <div class="row">
        <a href="/fascms" class="btn btn-primary">Kembali</a>
        <div class="col-md-12">
            <form action="{{ route('fasilitas.update', ['type' => 'fas', 'id' => $fasilitas->id]) }}" method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="30" name="content"
                        placeholder="Content">{{ $fasilitas->content }}</textarea>
                </div>
                <div class="form-group">
