...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            <form action="{{ route('fasilitas.update', ['type' => 'sar', 'id' => $sarana->id]) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <input type="hidden" class="form-control" name="id" value="{{ $sarana->id }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="30" name="content"
                        placeholder="Content">{{ $sarana->content }}</textarea>
                </div>
                <div class="form-group">
